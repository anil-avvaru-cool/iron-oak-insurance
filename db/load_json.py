...
def main():
    ...
    load_table(conn, "violations", violations,
    ["violation_id", "customer_id", "policy_number", "state",
     "violation_date", "violation_type", "points", "conviction_date", "expiry_date", "source"])
